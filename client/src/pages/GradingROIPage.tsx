  ...
  return (
    <div className="max-w-xl mx-auto animate-fade-up">
      ...
      <form onSubmit={handleCalculate} className="space-y-4">
            ...
            {[
              ...
              <div key={f.label}>
                ...
                <div className="relative">
                  <span
                    className="absolute left-3 top-1/2 -translate-y-1/2 mono text-sm select-none"
                    style={{ color: "var(--text-muted)" }}
                  >
                    $
                  </span>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  max="100"
                  value={psa10Prob}
                  onChange={e => setPsa10Prob(e.target.value)}
                  required
                  className="input-sleek"
                  style={{ paddingLeft: "1.6rem" }}
                />
        ...
        {error && (
          <div
            className="rounded-lg px-4 py-3 text-sm mono"
            style={{
      ...
      {result && vc && (
        <div className="mt-6 space-y-3 animate-fade-up">
          ...
          >
            ...
            <p className="serif text-3xl font-semibold" style={{ color: vc.color }}>
              {result.verdict}
            </p>
            ...
            {[
              {
                ...
                value: `${result.expected_profit >= 0 ? "+" : ""}$${result.expected_profit.toFixed(2)}`,
                color: result.expected_profit >= 0 ? "var(--green)" : "var(--red)",
              },
              {
                label: "PSA 10 Profit",
                value: `+$${result.psa10_profit.toFixed(2)}`,
                color: "var(--gold)",
              },
              {
                label: "PSA 9 Profit",
                value: `${result.psa9_profit >= 0 ? "+" : ""}$${result.psa9_profit.toFixed(2)}`,
                color: result.psa9_profit >= 0 ? "var(--green)" : "var(--red)",
              },
              {
                label: "Break-even Rate",
                value: `${result.break_even_psa10_rate}% PSA 10`,
              ...
              >
                ...
                <p className="mono text-xl font-medium" style={{ color: m.color }}>
                  {m.value}
                </p>
              </div>
            ))}
